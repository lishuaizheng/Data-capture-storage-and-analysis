...
#if it cannot identify the language of the website ,especially confusing with which part of the web it should identify, 
#     just copy the text directly or check the developer of chrome to find the part we should identify specifically
